    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10 bg-black/80 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="relative w-full max-w-4xl bg-[#0E1017] border border-white/15 rounded-2xl shadow-2xl overflow-hidden my-auto"
        >
          {/* Modal Header */}
          <div className="p-6 bg-surface border-b border-white/10 flex items-center justify-between">
          ...
          {/* Modal Content Body */}
          <div className="p-6 sm:p-8 space-y-6 text-slate-300 text-sm leading-relaxed max-h-[75vh] overflow-y-auto font-sans">
            {/* Disclaimer Alert */}
            <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs font-mono flex items-start space-x-3">
            ...
            <div className="space-y-3">
              <h4 className="text-base font-bold text-white">1. Executive Summary & Problem Formulation</h4>
              <p>
            ...
            <div className="space-y-3 pt-2 border-t border-white/10">
              <h4 className="text-base font-bold text-white">2. Economic Baseline (5-Car Scenario)</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono">
                <div className="p-3 rounded-lg bg-white/5 border border-white/5 space-y-1">
                  <div className="text-slate-400">DRIVER HOURLY RATE</div>
                  <div className="text-white font-bold">£16.00 / hour (paid portal-to-portal)</div>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-white/5 space-y-1">
                  <div className="text-slate-400">SHUTTLE VEHICLE COST</div>
                  <div className="text-white font-bold">£0.60 / mile (fuel, wear, insurance)</div>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-white/5 space-y-1">
                  <div className="text-slate-400">COLLECTED CAR MILEAGE</div>
                  <div className="text-white font-bold">£0.40 / mile</div>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-white/5 space-y-1">
                  <div className="text-slate-400">HANDOVER / WAITING TIME</div>
                  <div className="text-white font-bold">40 mins per seller site</div>
                </div>
              </div>
            </div>
            ...
            {/* Mathematical Model */}
            <div className="space-y-3 pt-2 border-t border-white/10">
              <h4 className="text-base font-bold text-white">3. Multi-Modal Optimisation Architecture</h4>
              <p>
          ...
          {/* Modal Footer */}
          <div className="p-4 bg-surface border-t border-white/10 flex justify-end">
            <button
              onClick={onClose}
