...
import { CheckCircle, Sliders, ShieldCheck, ArrowLeftRight } from "lucide-react";
import { CORE_INSIGHT_SPLIT } from "@/data/scenarioData";

export const CoreInsight: React.FC = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#090A0F] border-t border-white/5 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] bg-indigo-600/10 rounded-full blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-4 bg-surface border border-white/10 rounded-2xl p-8 flex flex-col justify-between relative overflow-hidden group"
          >
          ...
          <motion.div
            ...
            className="lg:col-span-8 bg-gradient-to-br from-indigo-950/40 via-surface to-slate-900 border border-indigo-500/30 rounded-2xl p-8 flex flex-col justify-between shadow-glow-sm relative overflow-hidden"
          >
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono text-indigo-400 uppercase tracking-wider bg-indigo-500/10 px-3 py-1 rounded-full border border-indigo-500/20">
              ...
              <div className="flex items-baseline space-x-3">
                <div className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-sky-300 to-emerald-300 font-mono">
            ...
            <div className="mt-8 pt-6 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 text-xs">
                <div className="font-semibold text-white mb-1">Driver Positioning</div>
                <div className="text-slate-400">Shuttle vs Train + Taxi vs Rideshare</div>
              </div>
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 text-xs">
                <div className="font-semibold text-white mb-1">Seller Readiness</div>
                <div className="text-slate-400">Pre-slot document & photo validation</div>
              </div>
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 text-xs">
                <div className="font-semibold text-white mb-1">Drop Sequence</div>
                <div className="text-slate-400">Minimising total paid driver hours</div>
              </div>
            </div>
          </motion.div>
        </div>
